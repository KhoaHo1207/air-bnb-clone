import { ListingReservationForm } from "@/components/listing/listing-reservation-form";
...
export function ListingBookingSidebar({
  ...
  return (
    <aside className="space-y-4 lg:sticky lg:top-20 lg:self-start">
      <section className="border-ink-200 bg-surface shadow-ink-900/5 rounded-3xl border p-5 shadow-lg">
        <div className="flex items-baseline justify-between">
          ...
          <p className="text-ink-500 hidden text-xs md:block">
            {reservationCount > 0
        ...
        <p className="text-ink-500 mt-1 text-xs md:hidden">
          Hosted by {hostName}
        </p>
        <div className="mt-4">
      ...
      <div className="border-ink-200 bg-surface/95 fixed inset-x-0 bottom-0 z-30 border-t px-4 py-3 shadow-[0_-8px_24px_-18px_rgba(15,23,42,0.35)] backdrop-blur md:px-6 lg:hidden">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-3">
          ...
          <a
            ...
            className="bg-brand-500 hover:bg-brand-600 inline-flex rounded-xl px-4 py-2 text-sm font-semibold text-white transition"
          >
