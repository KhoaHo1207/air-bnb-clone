        ...
        <div className="from-brand-50 to-brand-100 dark:from-brand-700/25 dark:via-surface dark:to-brand-600/15 bg-linear-to-br via-white p-8 md:p-10">
          ...
          <div className="text-ink-700 mt-8 space-y-3 text-sm">
            <p className="flex items-center gap-2">
              <House className="text-brand-500 dark:text-brand-400 size-4" />{" "}
              Personalize home recommendations
            </p>

            <p className="flex items-center gap-2">
              <ShieldCheck className="text-brand-500 dark:text-brand-400 size-4" />
              Secure account access
            </p>

            <p className="flex items-center gap-2">
              <Sparkle className="text-brand-500 dark:text-brand-400 size-4" />
